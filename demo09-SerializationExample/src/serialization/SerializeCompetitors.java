...
public class SerializeCompetitors
{
	...
	//Attributes
	private static long 	competitorOutputTime,
							competitorInputTime,
							queueOutputTime,
							queueInputTime;
	...
	public static void deserializeCompetitorsFromFile()
	{
		...
		try
		{
			ObjectInputStream ois = new ObjectInputStream(
						new FileInputStream("res/competitors.ser"));
	...
	public static void deserializeCompetitorQueueFromFile()
	{
		...
		{
			ObjectInputStream ois = new ObjectInputStream(
						new FileInputStream("res/queue.ser"));
	...
	{
		System.out.println("Time to output competitors individually = "+
								competitorOutputTime);
		System.out.println("Time to read competitors input file = "+
								competitorInputTime);
		System.out.println("Time to output competitors queue file = "+
				queueOutputTime);
		System.out.println("Time to read competitors queue file = "+
				queueInputTime);
	}
